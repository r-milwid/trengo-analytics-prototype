...
If no file specified, ask which file to update: `ARCHITECTURE.md`, `GUIDELINES.md`, or `~/.Codex/AGENTS.md`.
...
- **For AGENTS.md**: Verify meta-rules still reflect the user's working style. Remove anything redundant with built-in behavior.
...
- [ ] No contradictions between ARCHITECTURE.md, GUIDELINES.md, and AGENTS.md
